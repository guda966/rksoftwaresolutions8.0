    ...
    <div className="w-full bg-background min-h-screen pb-24">
      ...
      <section className="bg-primary text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
          <FadeIn>
            <div className="inline-flex items-center gap-2 bg-accent/15 text-accent border border-accent/60 px-4 py-2 rounded-full mb-6 text-sm font-bold max-w-fit mx-auto shadow-[0_0_10px_rgba(245,197,24,0.15)]">
