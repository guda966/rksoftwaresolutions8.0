...
const companies: Company[] = [
  { name: "Tata Consultancy Services", short: "TCS",        brand: "#003087", sector: "IT Services",     domain: "tcs.com",          logo: "https://img.logo.dev/tcs.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Infosys",                   short: "Infosys",    brand: "#007CC2", sector: "IT Services",     domain: "infosys.com",      logo: "https://img.logo.dev/infosys.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Wipro",                     short: "Wipro",      brand: "#341062", sector: "IT & Consulting", domain: "wipro.com",        logo: "https://img.logo.dev/wipro.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "HCL Technologies",          short: "HCL",        brand: "#0074B7", sector: "Technology",      domain: "hcltech.com",      logo: "https://img.logo.dev/hcltech.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Capgemini",                 short: "Capgemini",  brand: "#0070AD", sector: "Consulting",      domain: "capgemini.com",    logo: "https://img.logo.dev/capgemini.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Tech Mahindra",             short: "Tech-M",     brand: "#C4122F", sector: "IT Services",     domain: "techmahindra.com", logo: "https://img.logo.dev/techmahindra.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Cognizant",                 short: "Cognizant",  brand: "#1279BB", sector: "Technology",      domain: "cognizant.com",    logo: "https://img.logo.dev/cognizant.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Accenture",                 short: "Accenture",  brand: "#A100FF", sector: "Consulting",      domain: "accenture.com",    logo: "https://img.logo.dev/accenture.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "IBM",                       short: "IBM",        brand: "#1F70C1", sector: "Enterprise IT",   domain: "ibm.com",          logo: "https://img.logo.dev/ibm.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Oracle",                    short: "Oracle",     brand: "#F80000", sector: "Enterprise SW",   domain: "oracle.com",       logo: "https://img.logo.dev/oracle.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Amazon",                    short: "Amazon",     brand: "#FF9900", sector: "E-Commerce",      domain: "amazon.com",       logo: "https://img.logo.dev/amazon.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Microsoft",                 short: "Microsoft",  brand: "#00A4EF", sector: "Cloud & SW",      domain: "microsoft.com",    logo: "https://img.logo.dev/microsoft.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Flipkart",                  short: "Flipkart",   brand: "#2874F0", sector: "E-Commerce",      domain: "flipkart.com",     logo: "https://img.logo.dev/flipkart.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Deloitte",                  short: "Deloitte",   brand: "#86BC25", sector: "Consulting",      domain: "deloitte.com",     logo: "https://img.logo.dev/deloitte.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Mphasis",                   short: "Mphasis",    brand: "#CC2233", sector: "IT Services",     domain: "mphasis.com",      logo: "https://img.logo.dev/mphasis.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Hexaware",                  short: "Hexaware",   brand: "#E1261C", sector: "Technology",      domain: "hexaware.com",     logo: "https://img.logo.dev/hexaware.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "LTIMindtree",               short: "LTI",        brand: "#007DB8", sector: "IT Services",     domain: "ltimindtree.com",  logo: "https://img.logo.dev/ltimindtree.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Paytm",                     short: "Paytm",      brand: "#00B9F1", sector: "FinTech",         domain: "paytm.com",        logo: "https://img.logo.dev/paytm.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Zomato",                    short: "Zomato",     brand: "#E23744", sector: "Food Tech",       domain: "zomato.com",       logo: "https://img.logo.dev/zomato.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
  { name: "Swiggy",                    short: "Swiggy",     brand: "#FC8019", sector: "Food Tech",       domain: "swiggy.com",       logo: "https://img.logo.dev/swiggy.com?token=pk_D3Oy5HHoRsKMHMmzFMGXEA&size=200" },
];
